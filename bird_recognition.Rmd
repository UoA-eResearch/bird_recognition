...
## Using Random-Forest
```{r}
rf = randomForest(trainMels_20, train$birdid, xtest=testMels_20, ytest=test$birdid, importance = FALSE, proximity = FALSE, replace = TRUE, ntree = 4000, mtry = 4)
rf
```

```{r}
rf = randomForest(trainMels_stretched, train$birdid, xtest=testMels_stretched, ytest=test$birdid, importance = FALSE, proximity = FALSE, replace = TRUE, ntree = 4000, mtry = 54)
rf
```
