...
```{r split}
test.indices = sample(1:nrow(metadata), 20)
test = metadata[test.indices,]
test
train = metadata[-test.indices,]
train
```
...
testWithPredictions = data.frame(test, factor(predictions, levels=levels(test$birdid)))
testWithPredictions
